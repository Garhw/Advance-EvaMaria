...
API_ID = int(environ.get('API_ID', '2758310'))
API_HASH = environ.get('API_HASH', ''577aab09bea0e487a4e3ee577b085c8')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '100249911').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sachingarhwal12345:znYTUiLEARdjWrRM@cluster0.bfh2p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '100231601495'))
